...
import {ChevronRight, InsertDriveFile, MoreHoriz, Folder} from "@mui/icons-material";
    ...
    return (
      <>
        <div
          ...
          className="relative text-xs flex select-none cursor-pointer items-center justify-between gap-6 py-1 px-2 pr-1 text-slate-950 rounded hover:bg-slate-500 hover:text-gray-200"
        >
            ...
            {isCreating.showInput && (
              <form onSubmit={handleSubmission} className="flex items-center w-full gap-1.5">
                <span className="flex items-center justify-center text-vsdark-5">
                  {isCreating.isFolder ? <ChevronRight size={12} /> : <InsertDriveFile size={12} />}
                </span>
                <input
